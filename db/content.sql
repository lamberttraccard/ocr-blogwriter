/* raw password is 'password' */
INSERT INTO users VALUES
  (1,
   'admin',
   'lambert.traccard@gmail.com',
   '$2y$13$QBBGOZVQp8qdIKJcdNaFz.mweGdZJwf9eHbgfa3EXsy/U6ynasqvy',
   'dhMTBkzwDKxnD;4KNs,4ENy',
   'ROLE_ADMIN',
   NOW(),
   NOW()
  );
...
INSERT INTO users VALUES
  (
    ...
    'jane',
    'jane@doe.com',
    '$2y$13$qOvvtnceX.TjmiFn4c4vFe.hYlIVXHSPHfInEG21D99QZ6/LM70xa',
    'dhMTBkzwDKxnD;4KNs,4ENy',
    'ROLE_USER',
    NOW(),
    NOW()
...
INSERT INTO comments VALUES
  (
    '1',
    'Porro accusamus consequatur quam. Quos et quia sed voluptatem omnis. Vero et quod et est sunt.',
    '1',
    '1',
    NOW(),
    NOW()
...
INSERT INTO comments VALUES
  (
    '2',
    'Error soluta quia unde quas soluta nihil quis. Magni error quaerat placeat recusandae. Corporis commodi consequatur voluptatibus quas at ipsam. Voluptas aut libero mollitia et.',
    '1',
    '2',
    NOW(),
    NOW()
...
INSERT INTO comments VALUES
  (
    '3',
    'Magni enim itaque est optio. Dolore consequatur cum cum.',
    '1',
    '1',
    NOW(),
    NOW()
...
INSERT INTO comments VALUES
  (
    '4',
    'Fugiat sequi incidunt velit quae at. Repudiandae et quae tempora nemo id voluptatem consequatur.',
    '2',
    '1',
    NOW(),
    NOW()
